...
import { I as IconVisibilityOn } from './IconVisibilityOn.js';
import { I as IconError } from './icon-error.js';

// eslint-disable-next-line
const IconSearch = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-search ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '14', height: (_b = props.size) !== null && _b !== void 0 ? _b : 14, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor', xmlns: "http://www.w3.org/2000/svg" },
