...
const ModusDropdown = /*@__PURE__*/ proxyCustomElement(class ModusDropdown extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'e32fb0fe72497f32e7a90b2e48767c383ef57622', "aria-label": this.ariaLabel || undefined, class: dropdownClass, onClick: (event) => this.handleDropdownClick(event) }, h("slot", { key: '0a031d19e07eec95f2d24de69ab4decc03adc3e4', name: "dropdownToggle" }), h("div", { key: '237ea451c9d1ce9422fd606f7f35fd59625c140e', class: listContainerClass, style: {
                ...
                'min-width': width,
            } }, h("slot", { key: '7d2041fcc99fd43f1109f11e8330e8df006c07c3', name: "dropdownList" }))));
    }
    get el() { return this; }
