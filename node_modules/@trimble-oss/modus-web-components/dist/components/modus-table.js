...
import { P as PAGINATION_PAGEVIEW_TEXT, a as PAGINATION_SUMMARY_TEXT, C as COLUMN_DEF_ROW_SELECTION_ID, b as COLUMN_DEF_ROW_SELECTION_CSS, c as COLUMN_DEF_DATATYPE_KEY, d as COLUMN_DEF_DATATYPE_INTEGER, e as COLUMN_DEF_SHOWTOTAL, K as KEYBOARD_RIGHT, f as KEYBOARD_LEFT, g as KEYBOARD_ENTER, h as KEYBOARD_ESCAPE, i as KEYBOARD_TAB, H as HTML_ATTR_DATA_ACCESSOR_KEY, j as COLUMN_DEF_SUB_ROWS_KEY, k as KEYBOARD_SPACE, S as SORTED_ASCENDING, l as SORTED_DESCENDING, m as SORT_ASCENDING, n as SORT_DESCENDING, o as PAGINATION_DEFAULT_SIZES, E as EXPANDED_STATE_KEY, p as SORTING_STATE_KEY, q as PAGINATION_STATE_KEY, r as COLUMN_SIZING_STATE_KEY, s as COLUMN_VISIBILITY_STATE_KEY, t as COLUMN_ORDER_STATE_KEY, R as ROW_SELECTION_STATE_KEY, u as COLUMN_SIZING_INFO_STATE_KEY } from './modus-table.constants.js';
...
import { d as defineCustomElement$o } from './modus-autocomplete2.js';
import { d as defineCustomElement$n } from './modus-badge2.js';
import { d as defineCustomElement$m } from './modus-button2.js';
import { d as defineCustomElement$l } from './modus-checkbox2.js';
import { d as defineCustomElement$k } from './modus-chip2.js';
import { d as defineCustomElement$j } from './modus-date-input2.js';
import { d as defineCustomElement$i } from './modus-date-picker2.js';
import { d as defineCustomElement$h } from './modus-list2.js';
import { d as defineCustomElement$g } from './modus-list-item2.js';
import { d as defineCustomElement$f } from './modus-number-input2.js';
import { d as defineCustomElement$e } from './modus-pagination2.js';
import { d as defineCustomElement$d } from './modus-select2.js';
import { d as defineCustomElement$c } from './modus-table-cell-editor2.js';
import { d as defineCustomElement$b } from './modus-table-cell-main2.js';
import { d as defineCustomElement$a } from './modus-table-columns-visibility2.js';
import { d as defineCustomElement$9 } from './modus-table-dropdown-menu2.js';
import { d as defineCustomElement$8 } from './modus-table-filler-column2.js';
import { d as defineCustomElement$7 } from './modus-table-row-actions2.js';
import { d as defineCustomElement$6 } from './modus-table-row-actions-cell2.js';
import { d as defineCustomElement$5 } from './modus-table-row-actions-menu2.js';
import { d as defineCustomElement$4 } from './modus-table-toolbar2.js';
...
function defineCustomElement$1() {
    ...
    const components = ["modus-table", "modus-autocomplete", "modus-badge", "modus-button", "modus-checkbox", "modus-chip", "modus-date-input", "modus-date-picker", "modus-list", "modus-list-item", "modus-number-input", "modus-pagination", "modus-select", "modus-table-cell-editor", "modus-table-cell-main", "modus-table-columns-visibility", "modus-table-dropdown-menu", "modus-table-filler-column", "modus-table-row-actions", "modus-table-row-actions-cell", "modus-table-row-actions-menu", "modus-table-toolbar", "modus-text-input", "modus-tooltip"];
