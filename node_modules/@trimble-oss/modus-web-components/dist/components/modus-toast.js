...
import { I as IconError } from './icon-error.js';
import { b as IconWarning, I as IconInfo, a as IconCheckCircle } from './icon-warning.js';
import { I as IconHelp } from './icon-help.js';
import { I as IconClose } from './IconClose.js';
...
const ModusToast$1 = /*@__PURE__*/ proxyCustomElement(class ModusToast extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
