...
const ModusTreeView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '66babb70ff1b7fb4ee1c9d1bbff24fb2cd4b31dc' }, index.h("ul", { key: '60012ff7564d2d73dfebfd94fc998827a0ea6187', role: "tree", tabindex: this.disableTabbing ? 0 : null, onKeyDown: (e) => this.handleKeyDown(e) }, index.h("slot", { key: 'ac0971a2f22edf9fb65d197c7a7313b16fcb6d23', onSlotchange: () => this.handleTreeSlotChange() })), index.h(ModusContentTreeDragItem, { key: 'f68ae591618566c112a788215ea4027a3f471ec0', draggingState: this.itemDragState }, index.h("div", { key: '39a3842b2993fff40a5b224eb7646938e7dfc44f', class: "drag-indicator", tabIndex: -1 }))));
    }
