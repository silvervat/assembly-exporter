...
const ModusToast = class {
    constructor(hostRef) {
        ...
        this.iconByType = new Map([
            ['danger', index.h(iconWarning.IconWarning, { color: '#C81922', size: '18' })],
            ['dark', index.h(iconWarning.IconInfo, { color: 'white', size: '18' })],
            ['default', index.h(iconWarning.IconInfo, { size: '18' })],
            ['primary', index.h(iconWarning.IconInfo, { color: '#0D6AA8', size: '18' })],
            ['secondary', index.h(iconHelp.IconHelp, { size: '18' })],
            ['success', index.h(iconWarning.IconCheckCircle, { color: '#5E9331', size: '18' })],
            ['tertiary', index.h(iconWarning.IconInfo, { size: '18' })],
            ['warning', index.h(iconError.IconError, { color: '#FFBE00', size: '18' })],
        ]);
    ...
    render() {
        ...
        return (index.h("div", { key: '1eac3cdb6513fad3fb5581831e984cd3d7a472c4', "aria-label": this.ariaLabel || undefined, class: className, role: this.role }, this.showIcon && index.h("div", { class: "icon" }, icon), index.h("span", { key: '5931172f5009076f2b3c07244ecca40eb01ff60d', class: 'text' }, index.h("slot", { key: 'bc410ee678cc98974958df286761fb9c2bfacf90' })), this.dismissible && (index.h("button", { type: "button", class: 'close', onClick: () => this.dismissElement(), "aria-label": "Dismiss" }, index.h(IconClose.IconClose, { size: '18' })))));
    }
