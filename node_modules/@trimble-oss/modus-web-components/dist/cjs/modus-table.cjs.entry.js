...
const tableCellNavigation_utility = require('./table-cell-navigation.utility-16323c9d.js');
...
const IconArrowDown = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-arrow-down ${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 24 24", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16, xmlns: "http://www.w3.org/2000/svg" },
...
const IconArrowUp = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-arrow-up ${props.pressed ? 'pressed' : ''}`, "data-test-id": "iconArrowUp", fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 24 24", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16, xmlns: "http://www.w3.org/2000/svg" },
...
const ModusTablePagination = ({ context: { tableInstance: table, pageSizeList, data, manualPaginationOptions }, }) => {
    ...
    return (index.h("div", { class: "pagination-container" },
        index.h("div", { class: "items-per-page" },
            ...
            index.h("modus-select", { ariaLabel: "Select page size", "options-display-prop": "display", options: optionsList, onValueChange: handleChange, value: selectedPageSize })),
...
const ModusTableHeader = ({ context, onDragStart, getColumnResizing, setColumnResizing, }) => {
    ...
    return (index.h("thead", { class: tableHeadClass }, headerGroups === null || headerGroups === void 0 ? void 0 : headerGroups.map((headerGroup, index$1) => {
        ...
        return (index.h("tr", { key: headerGroup.id },
            ...
            rowActions.length > 0 && index.h("th", { class: "sticky-right", style: { width: `${rowActionsLength}px` } })));
    })));
};
...
const ModusTableCellCheckbox = ({ multipleRowSelection, row, isChecked, checkboxSize, }) => {
    ...
    return (index.h("td", { class: 'row-checkbox sticky-left ' + (checkboxSize !== null && checkboxSize !== void 0 ? checkboxSize : ''), tabIndex: 0, ref: (el) => (cellEl = el), onFocus: () => checkboxInput === null || checkboxInput === void 0 ? void 0 : checkboxInput.focusCheckbox(), onKeyDown: (e) => handleKeyDown(e) },
        index.h("modus-checkbox", { ariaLabel: "Select row", ref: (el) => (checkboxInput = el), checked: isChecked, indeterminate: multipleRowSelection && row.getIsSomeSelected(), size: checkboxSize, onCheckboxClick: () => row.toggleSelected() })));
};
...
const ModusTableBody = ({ context }) => {
    ...
    return (index.h("tbody", null, (_a = table.getRowModel()) === null || _a === void 0 ? void 0 : _a.rows.map((row) => {
        ...
        return (index.h("tr", { key: id, class: { 'enable-hover': hover, 'row-selected': isChecked } },
            rowSelection && (index.h(ModusTableCellCheckbox, { multipleRowSelection: multipleRowSelection, row: row, isChecked: isChecked, checkboxSize: checkboxSize })), (_a = getVisibleCells()) === null || _a === void 0 ? void 0 :
...
const ModusTable = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'dc057c6d1aceaae575f3bb65ba64a79c06115462', id: this._id }, index.h("div", { key: 'a2d8bbbe6dc0ac54854b4cf2c4b7b1792c203d93', style: { maxWidth: this.maxWidth } }, this.renderToolBar(), this.renderMain(), this.renderPagination(), index.h(ModusTableColumnDragItem, { key: 'b82f64eda607d40a45a76c91775b08a0efa36355', draggingState: this.itemDragState }), index.h(ModusTableColumnDropIndicator, { key: 'fdbb963ae68a35fba7f18da219ccc6ee1e053f5a', position: (_a = this.itemDragState) === null || _a === void 0 ? void 0 : _a.dropIndicator }), index.h("modus-table-row-actions-menu", { key: 'ac765be499f848eb2c155015aeb2e7a73edbd3a0', context: this._context }))));
    }
