...
const ModusTimePicker = class {
    ...
    render() {
        return (index.h("div", { key: 'c344689b86d18990cc4c003e77a3cd1837586aed', class: { 'modus-time-picker': true, disabled: this.disabled } }, index.h("div", { key: '75eb15def70838fdf3c2f3cb7e5fcd42e6b173d4', class: "time-input-wrapper" }, this.label || this.required ? (index.h("div", { class: 'label-container' }, this.label ? index.h("label", { htmlFor: "time-input" }, this.label) : null, this.required ? index.h("span", { class: "required" }, "*") : null, this.helperText ? index.h("label", { class: "sub-text helper" }, this.helperText) : null)) : null, index.h("div", { key: '4870c5600280829e12db2c44efbe5d69139ab161', class: `input-container ${this.errorText ? 'error' : this.validText ? 'valid' : ''} ${this.classBySize.get(this.size)}` }, this.renderTimeInput()), this.renderSubText()), index.h("div", { key: '4f8ee49d018277ec22755451e9f2d45889497312', class: "time-zone-wrapper" }, index.h("slot", { key: '11e3d8d2626a7bc5c72696ca019690874ececf7a', name: "timeZone" }))));
    }
