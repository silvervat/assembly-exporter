...
const IconSortAZ = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { "data-test-id": "iconSortAZ", class: `${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 32 32", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16, xmlns: "http://www.w3.org/2000/svg" },
...
const IconSortZA = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { "data-test-id": "iconSortZA", class: `${props.pressed ? 'pressed' : ''}`, xmlns: "http://www.w3.org/2000/svg", width: (_a = props.size) !== null && _a !== void 0 ? _a : 16, height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor', onClick: props.onClick, viewBox: "0 0 32 32" },
...
const ModusDataTable = class {
    ...
    `;
        return (index.h("table", { key: 'bb903b6dd2d3c5aa025b858f9a26a66ff1248cac', class: className }, index.h("colgroup", { key: 'afd0ce04b4c068839824ddc648e42e6241459752' }, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && index.h("col", { style: { width: '34px' } }), (_a = this.columns) === null || _a === void 0 ? void 0 :
            _a.map((column) => index.h("col", { style: { width: column.width } })), !!this.rowActions.length && index.h("col", { style: { width: '34px' } })), index.h("thead", { key: '6f9c407f63ff0817314f3d665bde71ac52c51601' }, index.h("tr", { key: '8947edd43bb022c4d4ad350a10c4cd573fbcd2c1' }, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && (index.h("th", null, index.h("div", { class: "column-header align-center" }, index.h("modus-checkbox", { checked: this.allSelected, onCheckboxClick: (e) => this.handleHeaderCheckboxClick(e.detail) })))), (_b = this.columns) === null || _b === void 0 ? void 0 :
            _b.map((column) => (index.h(ModusDataTableHeader, { column: column, onColumnHeaderClick: (id) => this.handleColumnHeaderClick(id), sortOptions: this.sortOptions, sortState: this.sortState }))), !!this.rowActions.length && index.h("th", null))), index.h("tbody", { key: 'e9c4b28917968636b3813f9d7561a527ed0a6d86' }, (_c = this.data) === null || _c === void 0 ? void 0 : _c.map((row) => {
            var _a;
