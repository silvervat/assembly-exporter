...
const ModusSlider = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '782fe8cb09fcf6164192a27cdf43a70aedbf4c46', "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel || undefined, class: className }, this.label && index.h("label", { htmlFor: this.sliderId }, this.label), index.h("input", { key: '8d64f9df8ce9a5b871856dbd13b9404c3b797b91', class: "slider", disabled: this.disabled, id: this.sliderId, max: this.maxValue, min: this.minValue, onChange: (event) => this.handleOnChange(event), onInput: (event) => this.handleOnInput(event), type: "range", value: this.value })));
    }
};
