...
const ModusTreeViewItem = class {
    constructor(hostRef) {
        ...
        this.itemLabelChange = index.createEvent(this, "itemLabelChange", 7);
    ...
    render() {
        ...
        return (index.h("li", Object.assign({ key: '87165001431895774c2bbe48c2a85c56c913f115' }, ariaControls, { class: `tree-item-container${selectionIndicator ? ' selected-indicator' : ''}` }), index.h("div", { key: '2f12d166fbbe3735651fec2af809723a9d3993cf', class: treeItemClass, onFocus: () => this.handleFocus(), onClick: (e) => this.handleItemClick(e), onKeyDown: (e) => this.handleKeyDownTreeItem(e), ref: (el) => this.handleRefItemContent(el), tabindex: tabIndex }, index.h(this.CustomSlot, { key: '544067c64d2cfa6f7c933c3dc681b862a418ba6e', className: `icon-slot drag-icon${!this.draggableItem ? ' hidden' : ''}`, defaultContent: index.h(ModusIconMap.ModusIconMap, { icon: "drag_indicator" }), name: this.SLOT_DRAG_ICON, tabIndex: 0, onKeyDown: (e) => this.handleDragKeyDown(e), onMouseDown: (e) => this.handleDrag(e) }), index.h("div", { key: '64e1af6b2432aa6d9f87b31dcdd0c4b7d8c1e011', "aria-disabled": "true", style: { paddingLeft: `${(level - 1) * 0.5}rem` } }), index.h("div", { key: '468f36199d8bccce894b61497925353660d0ed7f', class: `icon-slot${!expandable ? ' hidden' : ''}`, onClick: (e) => this.handleExpandToggle(e), onKeyDown: (e) => this.handleDefaultKeyDown(e, () => this.handleExpandToggle(e)), tabindex: expandable ? tabIndex : -1 }, index.h(this.CustomSlot, { key: '239a9afcc107b35d07753a660f5be23562511446', className: "inline-flex rotate-right", defaultContent: index.h(ModusIconMap.ModusIconMap, { icon: "expand_more", size: "24" }), display: !expanded, name: this.SLOT_EXPAND_ICON }), index.h(this.CustomSlot, { key: 'cc598195b05ef8d811709fea44b6affa93b5b6db', className: "inline-flex", defaultContent: index.h(ModusIconMap.ModusIconMap, { icon: "expand_more", size: "24" }), display: expanded, name: this.SLOT_COLLAPSE_ICON })), (checkboxSelection || multiCheckboxSelection) && (index.h("div", { class: "icon-slot" }, index.h("modus-checkbox", { checked: checked, disabled: isDisabled, indeterminate: indeterminate, onClick: (e) => this.handleCheckboxClick(e), onKeyDown: (e) => this.handleDefaultKeyDown(e, () => this.handleCheckboxClick(e)), ref: (el) => (this.refCheckbox = el) }))), index.h(this.CustomSlot, { key: '86d4e37b913e99569216ba4cdf46efd7a1dc4155', className: "icon-slot", name: this.SLOT_ITEM_ICON, display: this.slots.has(this.SLOT_ITEM_ICON) }), index.h("div", { key: '6ea867fb583e31cc6ba6b3368f1f4c701d71f048', role: "heading", "aria-level": level, class: "label-slot" }, index.h(this.CustomSlot, { key: '98658ee52fd64362f5c4c418e39d51e321b6cf3c', role: "button", name: this.SLOT_LABEL, defaultContent: this.editable ? (index.h("modus-text-input", { size: size == 'large' ? 'large' : 'medium', autoFocusInput: true, tabindex: 0, ref: (el) => (this.refLabelInput = el), value: this.label, onClick: (e) => this.handleLabelInputClick(e), onBlur: () => this.handleLabelInputBlur(), onKeyDown: (e) => this.handleLabelInputKeyDown(e) })) : (this.label) })), ((_a = this.actions) === null || _a === void 0 ? void 0 : _a.length) > 0 && index.h("modus-action-bar", { "visible-item-count": 3, actions: this.actions })), index.h("ul", { key: '7ca259e728642481cf342134ed69ad4d1455dbce', class: treeItemChildrenClass, role: "tree" }, index.h("slot", { key: 'ef2d1f930c3f96d79f8f66371add710b10fcd1bc', onSlotchange: () => this.handleTreeSlotChange() }))));
    }
