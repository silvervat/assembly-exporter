...
const iconCheck = require('./icon-check-1f41fb0b.js');

// eslint-disable-next-line
const IconRemove = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-remove ${props.pressed ? 'pressed' : ''}`, height: (_a = props.size) !== null && _a !== void 0 ? _a : 16, width: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const ModusChip = class {
    ...
    `;
        ...
        return (index.h("button", { key: 'a2b1f4dd79429b8819c3d86cb15ec83e88798134', "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel || undefined, id: this.chipId || undefined, class: chipClass, onClick: this.disabled ? null : (event) => this.onChipClick(event), tabIndex: 0, type: "button" }, this.imageUrl ? (index.h("img", { src: this.imageUrl, alt: "" })) : this.showCheckmark ? (index.h(iconCheck.IconCheck, { size: '16' })) : null, index.h("span", Object.assign({ key: '5f096da0d11883a39dca200ec7b97d08762fc230' }, style), this.value), this.showClose ? (index.h(IconRemove, { onClick: this.disabled ? null : (event) => this.onCloseClick(event), size: '16' })) : null));
    }
};
