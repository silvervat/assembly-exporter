...
const ModusButtonGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '28d9db4ebc26a82398ba1f87bba763d4bc136e6b', "aria-label": this.ariaLabel, "aria-disabled": this.ariaDisabled ? this.ariaDisabled : this.disabled ? 'true' : undefined, role: "group" }, index.h("slot", { key: '510059102a090f5eb28ac476b534cfcc3d6c1f4c' })));
    }
