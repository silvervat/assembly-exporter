...
const ModusTableColumnsVisibility = class {
    ...
    renderColumnsChecklist() {
        ...
        return this.getAllLeafColumns().map((column, index$1) => {
            var _a, _b;
    ...
    render() {
        return (index.h("div", { key: '7357d1c0c3efb961c410ee2191f516673ff1fe31', class: "columns-visibility-menu", style: { maxHeight: this.maxHeight || '60dvh' } }, index.h("div", { key: '156fc3b9d58040a473f888d81f9e6a00021aac3b', class: "column-visibility-header" }, this.columnsVisibility.title || 'Columns'), index.h("div", { key: '588ed7b5939c4bced93b593032584c852208cd02', class: "column-visibility-content" }, this.renderColumnsChecklist()), this.renderCancelApplyButtons()));
    }
};
...
const IconHorizontalEllipsis = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-horizontal-ellipsis ${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? () => props.onClick() : null, viewBox: "0 0 24 24", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16, xmlns: "http://www.w3.org/2000/svg" },
...
const ModusTableDropdownMenu = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'aab90de74a93625cd6dad906d014cc3afed51693', class: "dropdown-menu-container" }, index.h("div", { key: 'e9d0bb984aa0442278b86acee7d5d124232f1cf0', tabIndex: 0, class: "dropdown-menu-icon", onClick: () => (this.show = !this.show), onKeyDown: (event) => this.handleIconKeyDown(event), ref: (el) => (this.menuIconContainerRef = el) }, index.h(IconHorizontalEllipsis, { key: '54f8128ab8b0150fe952f159b2f1578941844624', size: "20" })), (options === null || options === void 0 ? void 0 : options.columnsVisibility) && (index.h("div", { onKeyDown: (event) => this.handleDropdownKeyDown(event), class: `dropdown-menu ${this.show ? 'visible' : ''}` }, index.h("modus-table-columns-visibility", { getAllLeafColumns: getAllLeafColumns, columnsVisibility: options === null || options === void 0 ? void 0 : options.columnsVisibility, showDropdown: this.show, menuIconContainerRef: this.menuIconContainerRef, toggleDropdown: (show) => (this.show = show), maxHeight: maxHeight })))));
    }
};
