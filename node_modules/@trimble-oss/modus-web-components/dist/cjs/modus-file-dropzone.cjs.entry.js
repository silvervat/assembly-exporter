...
const IconUploadCloud = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `upload-cloud ${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 24 24", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16, xmlns: "http://www.w3.org/2000/svg" },
...
const IconCancel = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-cancel ${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 32 32", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16, xmlns: "http://www.w3.org/2000/svg" },
...
const ModusFileDropzone = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a28efaad7589a66012dff1179ae68de225276078', "aria-label": this.ariaLabel, role: "button" }, index.h("div", { key: '7c7fd3c81b581411a22edab8ede593841d06d630', class: "modus-file-dropzone" }, index.h("input", { key: '3af2cda73276898e5cacdf03d9800e7e2d3e238f', onChange: this.onFileChange, multiple: this.multiple, ref: (el) => (this.fileInput = el), type: "file", accept: this.acceptFileTypes }), index.h("div", { key: 'eeaa4f3dd26eb355552664b4ba0ddc0478445c18', class: "header" }, index.h("label", { key: 'af7d02cc07567f4d4bb0b1742002887454b56b03' }, this.label), index.h("span", { key: 'bc7128592d6512f2257f5bca8cb9228c804a4331' }, this.description)), index.h("div", { key: '887d2793101068701278c088ce11afb66e03a645', class: {
                dropzone: true,
                error: !!this.error,
            ...
            (this.fileDraggedOver ? (this.fileDraggedOverInstructions) : (index.h("div", { class: "browse", onClick: this.openBrowse }, this.instructions))), this.error && (index.h("div", { class: "error-messages", role: "alert" }, this.errorMessageTop && index.h("span", null, this.errorMessageTop), this.errorMessageBottom && index.h("span", null, this.errorMessageBottom)))))));
    }
};
