...
const ModusButton = class {
    ...
    render() {
        ...
        return (index.h("button", { key: '7a75a381d94fa0c6d8d9ec451a80155008ce3583', "aria-disabled": this.ariaDisabled ? this.ariaDisabled : this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel || undefined, "aria-pressed": this.pressed ? 'true' : undefined, class: className, disabled: this.disabled, onClick: () => {
                if (!this.disabled) {
                    this.buttonClick.emit();
                    if (this.type === 'toggle') {
            ...
            }, onKeyDown: () => (this.pressed = true), onKeyUp: () => (this.pressed = false), onMouseDown: () => (this.pressed = true), onMouseUp: () => (this.pressed = false), ref: (el) => (this.buttonRef = el), type: this.type }, this.iconOnly ? this.renderIconOnly() : this.renderIconWithText(), this.showCaret && index.h(ModusIconMap.ModusIconMap, { size: "24", icon: "caret_down" })));
    }
