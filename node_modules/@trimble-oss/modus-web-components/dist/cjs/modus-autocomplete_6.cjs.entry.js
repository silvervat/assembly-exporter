...
const iconSearch = require('./icon-search-b7ed2809.js');
const utils = require('./utils-86e5121d.js');
const ModusIconMap = require('./ModusIconMap-15cda955.js');
const modusTable_constants = require('./modus-table.constants-b3626e38.js');
...
const ModusAutocomplete = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '165a50a77a5ded35f0c8537c76100e4ee3e4554d', "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": !!this.errorText, "aria-label": this.ariaLabel || undefined, "aria-readonly": this.readOnly, "aria-required": this.required, class: classes, onFocusin: () => {
                if (this.hasFocus) {
                    return;
                }
                this.hasFocus = true;
            ...
            }, onKeyDown: (e) => this.handleInputKeyDown(e) }, this.label || this.required ? (index.h("div", { class: 'label-container' }, this.label ? index.h("label", null, this.label) : null, this.required ? index.h("span", { class: "required" }, "*") : null)) : null, index.h("div", { key: 'c6c10f829e890b7cfbc69f3adb42ad3b564b025d', class: "chips-container" }, this.includeSearchIcon ? index.h(iconSearch.IconSearch, { size: "16" }) : null, this.selectedChips.map((chip) => (index.h("modus-chip", { value: chip.value, chipId: chip.id, size: this.size === 'large' ? 'medium' : 'small', "show-close": true, onCloseClick: () => this.handleCloseClick(chip) }))), this.TextInput()), index.h("div", { key: '8180012cd41df4c11c2d120a194e674abb69a1d0', class: 'error' }, this.errorText ? index.h("label", { class: "sub-text error" }, this.errorText) : null), index.h("div", { key: '5447a91e2fc49f013869f2a2102636fccced1534', class: "options-container", style: { maxHeight: this.dropdownMaxHeight, zIndex: this.dropdownZIndex, overflowY: 'auto' } }, index.h("ul", { key: '4bf60b01f2a76d18384a34f5c604c5da164e481f', id: this.listId, "aria-label": "options", role: "listbox" }, this.displayOptions() &&
            ((_a = this.visibleOptions) === null || _a === void 0 ? void 0 : _a.map((option) => {
                ...
                return (index.h("li", { class: className, tabindex: "-1", role: "option", onClick: () => this.handleOptionClick(option), onKeyDown: (e) => this.handleOptionKeyDown(e, option) }, option.value, isSelected && index.h(ModusIconMap.IconCheck, { size: "16" })));
            })), this.displayOptions() &&
            ((_b = this.visibleCustomOptions) === null || _b === void 0 ? void 0 : _b.map((option) => {
                ...
                return (index.h("li", { class: className, tabindex: "-1", role: "option", onClick: () => this.handleCustomOptionClick(option), onKeyDown: (e) => this.handleOptionKeyDown(e, option, true), innerHTML: option.outerHTML }));
            }))), this.displayNoResults() && index.h(NoResultsFound, { text: this.noResultsFoundText, subtext: this.noResultsFoundSubtext })), this.CustomOptionsSlot()));
    }
...
const ModusDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '45ef27e63b41e4b08a1c084acfc0b9d9d92070e3', class: "modus-date-picker" }, this.label ? index.h("div", { class: 'label-container' }, this.label ? index.h("label", null, this.label) : null) : null, index.h("div", { key: '8db804f8291c99e8be8434d81491769b8e2ff604', class: "date-inputs", part: "date-inputs" }, index.h("slot", { key: 'b003c1220288f9aa056c1cabc4e17d0c20851631', onSlotchange: () => this.handleSlotChange() })), index.h("div", { key: '973e68544060a5c9bc74f15ef79e21815eee3ba7', style: { display: 'inline-flex' } }, this._showCalendar && (index.h("nav", { class: "calendar-container", "aria-label": "Pick a Date" }, this.renderCalendarHeader(), this.renderCalendarBody())))));
    }
    get element() { return index.getElement(this); }
};
...
const ModusSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7d7af883b684c5f73670fa3423d2e994c740627a', class: this.disabled ? 'disabled' : undefined }, this.renderLabel(), index.h("span", { key: '034f3f8ffe4f7b5fba92feb904ee94da4958d7ea', class: "input-container" }, index.h("select", { key: '7bdf01255ec7aa2ed756cd72f6b52b408e67b6e2', part: "input", ref: (el) => (this.selectInput = el), disabled: this.disabled, id: this.selectId, class: selectClass, "aria-label": this.ariaLabel || undefined, onBlur: (e) => this.inputBlur.emit(e), onChange: (event) => {
                this.handleSelectChange(event);
            }, "aria-invalid": !!this.errorText, "aria-required": (_a = this.required) === null || _a === void 0 ? void 0 : _a.toString() }, index.h("option", { key: '0911199be88ca56fb9ff1c063d9dede8c224c97a', value: "", disabled: true, selected: true }, this.placeholder), this.renderOptions()), this.renderSubText())));
    }
    static get watchers() { return {
        "value": ["handleValueChange"]
    }; }
...
const ModusTableCellEditor = class {
    ...
    createErrorTooltip() {
        if (!this.errorTooltip) {
            ...
            this.popperInstance = popper.createPopper(this.inputElement, this.errorTooltip, {
    ...
    renderTextInput() {
        return (index.h("modus-text-input", Object.assign({}, this.getDefaultProps('Text input'), { value: this.value, onValueChange: (e) => (this.editedValue = e.detail), onBlur: this.handleBlur, onKeyDown: this.handleKeyDown, autoFocusInput: true, size: "large" })));
    }
    renderSelectInput() {
    ...
    renderDateInput() {
        ...
        return (index.h("modus-date-picker", { onBlur: this.handleBlur, onClick: (e) => e.stopPropagation(), class: "date-picker-container" }, index.h("modus-date-input", Object.assign({}, this.getDefaultProps('Date input'), { format: format, size: "large", "show-calendar-icon": "true", value: this.value, onValueChange: (e) => {
    ...
    renderAutocompleteInput() {
        ...
        return (index.h("div", { class: "autocomplete-container" }, index.h("modus-autocomplete", Object.assign({}, this.getDefaultProps('Autocomplete input'), { "include-search-icon": "false", size: "medium", options: options, onBlur: this.handleBlur, onKeyDown: (e) => e.stopPropagation(), onOptionSelected: (e) => {
    ...
    render() {
        return index.h(index.Host, { key: '27197918d3cbb8d084d13c51c3ec4be2ae27038d' }, this.renderEditor());
    }
};
