...
const ModusModal = class {
    ...
    renderModalHeader() {
        return (index.h("header", null, this.headerText, index.h("div", { role: "button", tabindex: 0, "aria-label": "Close", onClick: () => this.close(), onKeyDown: (event) => this.handleCloseKeydown(event) }, index.h(iconClose.IconClose, { size: "20" }))));
    }
    renderModalFooter() {
        return (index.h(index.Fragment, null, index.h("footer", { class: {
            ...
            } }, this.secondaryButtonText && (index.h("modus-button", { disabled: this.secondaryButtonDisabled, "button-style": "outline", color: "secondary", ariaLabel: this.secondaryButtonAriaLabel, onButtonClick: () => this.secondaryButtonClick.emit(), onKeyDown: (event) => this.handlePrimaryKeydown(event) }, this.secondaryButtonText)), this.primaryButtonText && (index.h("modus-button", { disabled: this.primaryButtonDisabled, color: "primary", ariaLabel: this.primaryButtonAriaLabel, onButtonClick: () => this.primaryButtonClick.emit(), onKeyDown: (event) => this.handleSecondaryKeydown(event) }, this.primaryButtonText)), index.h("slot", { name: "footerContent" }))));
    }
    render() {
        return (index.h("div", { key: '5d1ba92884aae3cb2520fefb3c056d2dbcfcb3e4', "aria-hidden": this.visible ? undefined : 'true', "aria-label": this.visible ? this.ariaLabel || undefined : undefined, "aria-modal": this.visible ? 'true' : undefined, class: `modus-modal ${this.fullscreen ? 'fullscreen' : ''} overlay ${this.visible ? 'visible' : 'hidden'}`, onClick: (event) => this.handleOverlayClick(event), role: this.visible ? 'dialog' : undefined, style: { zIndex: this.zIndex } }, this.renderModal()));
    }
