...
const IconMenu = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-menu ${props.pressed ? 'pressed' : ''}`, height: (_a = props.size) !== null && _a !== void 0 ? _a : 16, width: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor', xmlns: "http://www.w3.org/2000/svg" },
...
const IconNotifications = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-notifications ${props.pressed ? 'pressed' : ''}`, height: (_a = props.size) !== null && _a !== void 0 ? _a : 16, width: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor', xmlns: "http://www.w3.org/2000/svg" },
...
const IconApps = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-apps ${props.pressed ? 'pressed' : ''}`, height: (_a = props.size) !== null && _a !== void 0 ? _a : 16, width: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor', xmlns: "http://www.w3.org/2000/svg" },
...
const ModusNavbarButtonList = ({ buttons, reverse, onClick, onKeyDown, openButtonMenuId }) => {
    ...
    return navbarButtons.map((button, index$1) => {
        ...
        return (index.h("div", { onClick: (event) => onClick(event, button), onKeyDown: (event) => onKeyDown(event, button) },
            index.h("modus-dropdown", { "toggle-element-id": 'navbar-button-' + index$1, showDropdownListBorder: false },
