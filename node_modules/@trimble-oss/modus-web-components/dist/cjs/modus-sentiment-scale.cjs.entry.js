...
const IconSmileySatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-satistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconSmileySatisfied = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-satistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconSmileySomewhatSatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-somewhat-satistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconSmileySomewhatSatisfied = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-somewhat-satistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconSmileyNeutralOutline = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-neutral-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconSmileyNeutral = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-neutral ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconSmileySomewhatDissatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-somewhat-dissatistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconSmileySomewhatDissatisfied = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-somewhat-dissatistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconSmileyDissatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-dissatistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconSmileyDissatisfied = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-dissatistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconThumbsUpOutlined = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-thumbs-up-outlined ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '14', height: (_b = props.size) !== null && _b !== void 0 ? _b : 14, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconThumbsUp = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-thumbs-up ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconThumbsDownOutlined = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-thumbs-down-outlined ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '14', height: (_b = props.size) !== null && _b !== void 0 ? _b : 14, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const IconThumbsDown = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-thumbs-down ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const ModusSentimentScale = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '761003c811ba9eb61083c18cc721b1c287e91033', class: "sentiment-scale-container", "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel || undefined, role: "group" }, iconsMap &&
