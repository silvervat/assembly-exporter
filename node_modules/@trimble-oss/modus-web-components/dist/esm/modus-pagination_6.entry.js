...
import { I as IconChevronLeft } from './IconChevronLeft-f85188e7.js';
import { I as IconChevronRight } from './IconChevronRight-de7de2e8.js';
import { g as KEYBOARD_ENTER, k as KEYBOARD_SPACE, h as KEYBOARD_ESCAPE, x as COLUMN_DEF_CELL_EDITOR_ARGS_KEY, c as COLUMN_DEF_DATATYPE_KEY, y as CELL_EDIT_TYPE_TEXT, A as ALLOWED_CELL_EDIT_TYPES, z as COLUMN_DEF_DATATYPE_BADGE, d as COLUMN_DEF_DATATYPE_INTEGER, B as COLUMN_DEF_DATATYPE_LINK, D as COLUMN_DEF_CELL_EDITOR_TYPE_KEY } from './modus-table.constants-c083d0c0.js';
...
const ModusTablePanel = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'fcbd8a1bec08ca5f4a11de68eac6b2a708127ee1' }, h("div", { key: 'd218fafadd7beb53e8c43ab0e45bf566a5996a0b', class: "table-toolbar" }, h("div", { key: 'e1d07736405cbb3828070c2f9b93a87fb9848937', class: "section" }, h("slot", { key: '89737c466d0a8e0baea9a4e9f89bf64893bc110c', name: "group-left" })), h("div", { key: '86342197962d9c921c8b8421539cee22a36226f9', class: "section" }, h("slot", { key: 'eb7745a45dc1c629d174414004efb47803971b49', name: "group-right" }), h("modus-table-dropdown-menu", { context: this.context })))));
    }
};
